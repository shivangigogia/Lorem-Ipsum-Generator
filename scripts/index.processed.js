...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HaikuGenerator = __webpack_require__(300);

	var _FormComponent = __webpack_require__(302);

	var _FormComponent2 = _interopRequireDefault(_FormComponent);

	var _ResultComponent = __webpack_require__(303);

	var _ResultComponent2 = _interopRequireDefault(_ResultComponent);

	var _ModalComponent = __webpack_require__(305);

	var _ModalComponent2 = _interopRequireDefault(_ModalComponent);

	var _FieldComponent = __webpack_require__(306);

	var _FieldComponent2 = _interopRequireDefault(_FieldComponent);

	var _ScreenComponent = __webpack_require__(307);
	...
	*/
	...
	exports.default = {
	  ...
	  unsubscribe: function unsubscribe(eventName, fn) {
	    var eventNameFns = this.events[eventName];
	    if (eventNameFns) {
	      eventNameFns.every(function (eventNameFn, i) {
	        if (eventNameFn === fn) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _haikuUtils = __webpack_require__(301);
	...
	function generateHaiku() {
	  ...
	  (0, _haikuUtils.fetchWordData)(word).then(function (_ref) {
	    var adj = _ref.adj,
	        triggers = _ref.triggers,
	        relatedWords = _ref.relatedWords,
	        kindOfWords = _ref.kindOfWords,
	        precedingWords = _ref.precedingWords,
	        followingWords = _ref.followingWords;


	    var allRelatedWords = [].concat(_toConsumableArray(adj), _toConsumableArray(triggers), _toConsumableArray(relatedWords), _toConsumableArray(kindOfWords), _toConsumableArray(precedingWords), _toConsumableArray(followingWords));
	    ...
	    if (haikuArray.indexOf(undefined) !== -1) {
	      haikuTitle = "Error.";
	      haiku = "Well, this is so awk <br />Something did not go as planned<br/>Try another word.";
	    } else {
	      haikuTitle = word + '.';
...
/***/ function(module, exports) {
	...
	exports.fetchWordData = fetchWordData;
	...
	function fetchAdj(word) {
	  var adjUrl = "https://api.datamuse.com/words?rel_jjb=" + word + "&md=s,p";
	  return fetchJSON(adjUrl);
	}

	function fetchTriggers(word) {
	  var triggerWordsUrl = "https://api.datamuse.com/words?rel_trg=" + word + "&md=s,p";
	  return fetchJSON(triggerWordsUrl);
	}

	function fetchRelatedWords(word) {
	  var relatedWordsUrl = "https://api.datamuse.com/words?rel_syn=" + word + "&md=s,p";
	  return fetchJSON(relatedWordsUrl);
	}

	function fetchKindOfWords(word) {
	  var kindOfWordsUrl = "https://api.datamuse.com/words?rel_spc=" + word + "&md=s,p";
	  return fetchJSON(kindOfWordsUrl);
	}

	function fetchPrecedingWords(word) {
	  var precedingWordUrl = "https://api.datamuse.com/words?rel_bgb=" + word + "&md=s,p";
	  return fetchJSON(precedingWordUrl);
	}

	function fetchFollowingWords(word) {
	  var followingWordUrl = "https://api.datamuse.com/words?rel_bga=" + word + "&md=s,p";
	  return fetchJSON(followingWordUrl);
	}

	function fetchWordData(word) {
	  var promises = [fetchAdj(word), fetchTriggers(word), fetchRelatedWords(word), fetchKindOfWords(word), fetchPrecedingWords(word), fetchFollowingWords(word)];

	  return Promise.all(promises).then(function (_ref) {
	    var _ref2 = _slicedToArray(_ref, 6),
	        adj = _ref2[0],
	        triggers = _ref2[1],
	        relatedWords = _ref2[2],
	        kindOfWords = _ref2[3],
	        precedingWords = _ref2[4],
	        followingWords = _ref2[5];

	    return {
	      adj: adj,
	      triggers: triggers,
	      relatedWords: relatedWords,
	      kindOfWords: kindOfWords,
...
/***/ function(module, exports) {
	...
	exports.default = function (elm, fn) {
	  // bind events
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  // cache DOM
	  var haikuSpace = document.getElementById("haiku"),
	      haikuTitleElm = document.getElementById("haiku-title"),
	      refreshBtn = document.getElementById("refresh"),
	      backBtn = document.getElementById("back");

	  // bind events
	  (0, _ButtonComponent2.default)(backBtn, function (e) {
	    return _pubSub2.default.emit('clickedBack');
	  });
	  (0, _ButtonComponent2.default)(refreshBtn, function () {
	    refreshBtn.classList.add("active");
	    (0, _HaikuGenerator.generateHaiku)();
	  });

	  refreshBtn.addEventListener("webkitAnimationEnd", function () {
	    _pubSub2.default.emit('refreshAnimationEnded');
	  });

	  _pubSub2.default.subscribe('refreshAnimationEnded', function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (modal, container) {
	  function openModal() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  ...
	  _pubSub2.default.subscribe('validationErrored', function () {
